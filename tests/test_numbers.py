...
@pytest.mark.parametrize("number_type", (Real,))
class TestNumbers:
    def test_constructors_and_equality(self, number_type: Type):
        a = number_type(5)
    ...
    def test_operators(self, number_type: Type):
        a = number_type(5)
    ...
    def test_comparison(self, number_type: Type, other_type: Type):
    ...
    def test_functions(self, number_type: Type):
        a = number_type(-5)
    ...
    def test_pickling(self, number_type: Type):
        import pickle
